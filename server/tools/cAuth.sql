...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='asdfadsf用户信息';
...
-- 表的结构 `friendsnetwork`
--
DROP TABLE IF EXISTS `friendsnetwork`;
...
--
DROP TABLE IF EXISTS `fighting_record`;
